...
class CPU8Test {
    ...
    void fetchInstructionsPSH() {
        var cpu = new CPU8();
        var instruction = encodeInstruction(CPU8.OPCODE_PSH, 2);
        var bus = new Machine8MemoryBus(new int[]{instruction});
        cpu.attachMemoryBus(bus);
        cpu.acc.set(10);
        assertEquals(CPU8.CPU_STATE_READY, cpu.s.get());
    ...
    void fetchInstructionsPop() {
        var cpu = new CPU8();
        var instruction = encodeInstruction(CPU8.OPCODE_POP, 3);
        var bus = new Machine8MemoryBus(new int[]{instruction});
        bus.push(3, 155);
        cpu.attachMemoryBus(bus);
        cpu.acc.set(10);
    ...
    void fetchInstructionJmp() {
        var cpu = new CPU8();
        var instruction = encodeInstruction(CPU8.OPCODE_JMP, 3);
        var bus = new Machine8MemoryBus(new int[]{instruction});
        bus.storeData(3, 7);
        cpu.attachMemoryBus(bus);
        cpu.acc.set(6);
    ...
    void fetchInstructionJnz_accIsNotZero() {
        var cpu = new CPU8();
        var instruction = encodeInstruction(CPU8.OPCODE_JNZ, 3);
        var bus = new Machine8MemoryBus(new int[]{instruction});
        bus.storeData(3, 7);
        cpu.attachMemoryBus(bus);
        cpu.acc.set(6);
    ...
    void fetchInstructionJmz_accIsNotZero() {
        var cpu = new CPU8();
        var instruction = encodeInstruction(CPU8.OPCODE_JMZ, 3);
        var bus = new Machine8MemoryBus(new int[]{instruction});
        bus.storeData(3, 7);
        cpu.attachMemoryBus(bus);
        cpu.acc.set(6);
    ...
    void fetchInstructionXor() {
        var cpu = new CPU8();
        var instruction = encodeInstruction(CPU8.OPCODE_XOR, 3);
        var bus = new Machine8MemoryBus(new int[]{instruction});
        bus.storeData(3, 7);
        cpu.attachMemoryBus(bus);
        cpu.acc.set(10);
